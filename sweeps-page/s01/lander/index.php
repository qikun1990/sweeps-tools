...
$client = new KClient('https://douyu.buzz/api.php?', 'JhhR2vD3Q6wgwFsP');
...
<title>Loyalty Program! Win Free iPhone, iPad, Gift Card...</title>
...
<script>
    ...
    img.src = wrapUrlWithClickId('https://tracker.net/click.php?event9=1');
